...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Hobi Mahasiswa Polinema</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Hobi Mahasiswa Polinema</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                @foreach ($hb as $i => $h)
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        <a href="{{ url('/hobi/'. $h->id.'/edit') }}" class="btn btn-sm btn-warning mr-2">edit</a>
