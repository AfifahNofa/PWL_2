...
<div class="content-wrapper">
  ...
  <div class="modal fade" id="modal_mahasiswa" style="display: none;" aria-hidden="true">
    <form method="post" action="{{ url('mahasiswa') }}"  enctype="multipart/form-data" role="form" class="form-horizontal" id="form_mahasiswa">
        @csrf
        <div class="modal-dialog modal-">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{-- <div class="form-group required row mb-2">
                      <label class="col-sm-2 control-label col-form-label" for="foto">Foto</label>
                      <div class="col-sm-10">
                          <input type="file" class="form-control form-control-sm" required="required" name="foto" id="foto">
                      </div>
                  </div> --}}
                    <div class="form-group required row mb-2">
      ...
      $(document).ready(function (){
        var dataMahasiswa = $('#data_mahasiswa').DataTable({
            ...
            columns: [{
                    ...
                    //     return data != null ? `<img src="{{ asset('storage') }}/` + data + `" width="50px" height="50px">` : 'no image';
                    //     }
                    // },
                    {
                        data: 'jk',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            var btn = `<button data-url="{{ url('/mahasiswa') }}/` + data +
                                ...
                                Edit</button>
                                <a href="{{ url('mahasiswa') }}/` + row.id + `" class="btn btn-xs btn-info"><i class="fa
                                fa-list"></i> Detail</a>
